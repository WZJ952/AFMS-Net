...
from utils.utils_loss_func import cal_kl_loss, cal_loss, cal_triplet_loss, Tripletloss, TripletLoss,AdaptiveStructuralPolyLoss,FocalLoss,PolyLoss
...
def get_parse():
    ...
    parser.add_argument('--share', action='store_true', default=False, help='share weight between different view' )
...
def train_model(model, opt, optimizer, scheduler, dataloaders, dataset_sizes):
    ...
    criterion = AdaptiveStructuralPolyLoss()
    # criterion = PolyLoss()
    # criterion = FocalLoss()

...
class PatchEmbed_overlap(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.proj(x) # for image size 3*384*384, after proj() -> [b, 768, 24, 24] => 24*16(patch size)=384
...
### Create Vit-S backbone
def vit_small_patch16_224_backbone(img_size=(256, 128), stride_size=16, drop_rate=0., attn_drop_rate=0.,drop_path_rate=0.1, local_feature=False,  **kwargs):
